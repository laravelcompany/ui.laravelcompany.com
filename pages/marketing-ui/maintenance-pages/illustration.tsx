...
const IllustrationMaintenancePage: FC = function () {
  return (
      ...
      <div className="mx-auto max-w-screen-xl px-4 py-8 lg:py-16">
        <div className="grid items-center gap-8 lg:grid-cols-12 lg:gap-12">
          <div className="col-span-6 text-center sm:mb-6 lg:mb-0 lg:text-left">
            <svg
              aria-hidden
              className="mx-auto mb-4 h-12 w-12 text-gray-500 dark:text-gray-400 lg:ml-0"
            ...
            <p className="mx-auto max-w-xl text-gray-500 dark:text-gray-400 md:text-lg lg:mx-0 xl:mb-8 xl:text-xl">
              ...
              <a
                href="#"
                className="font-semibold text-primary-600 hover:underline dark:text-primary-500 mx-1"
              >
                Twitter
              </a>
              or our
...
export default IllustrationMaintenancePage;
