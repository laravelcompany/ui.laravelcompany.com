...
const LogoMaintenancePage: FC = function () {
  return (
    <section className="bg-white dark:bg-gray-900">
      <div className="mx-auto max-w-screen-md px-4 py-8 text-center lg:px-12 lg:py-16">
        <a
          href="#"
          className="mb-5 flex items-center justify-center text-3xl font-semibold text-gray-900 dark:text-white"
        >
          <svg
            aria-hidden
            className="mr-3 h-10"
        ...
        <p className="text-gray-500 dark:text-gray-400 md:text-lg xl:text-xl">
          Unfortunately this site is down for a bit of maintenance right now. But
          soon we'll be up with a new library and over
...
export default LogoMaintenancePage;
