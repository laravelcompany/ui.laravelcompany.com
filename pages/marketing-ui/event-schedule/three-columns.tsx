...
const EventScheduleTimelineThreeColumns: FC = function () {
  return (
        ...
        <div className="grid grid-cols-1 mt-12 -mx-8 lg:mt-16 lg:grid-cols-3 gap-y-12">
          <div className="px-8 space-y-12">
            ...
            <Timeline className="border-0">
              <Timeline.Item className="space-y-3">
                <Timeline.Time>
              ...
              <Timeline.Item className="space-y-3 p-3 bg-gray-100 rounded-lg dark:bg-gray-800">
                <Timeline.Time>
                  <Badge className="w-fit">
                    <svg
                      aria-hidden="true"
          ...
          <div className="px-8 space-y-12 border-l border-r border-gray-200 dark:border-gray-700">
            ...
            <Timeline className="border-0">
              ...
              <Timeline.Item className="space-y-3">
                ...
                <Timeline.Title>
                  The importance of platform optimisation in times of expensive
                  ads
                </Timeline.Title>
                <Timeline.Body>
                  <Avatar
              ...
              <Timeline.Item className="space-y-3 bg-gray-100 p-3 rounded-lg dark:bg-gray-800">
                <Timeline.Time>
                  <Badge className="w-fit">
                    <svg
                      aria-hidden="true"
          ...
          <div className="px-8 space-y-12">
            ...
            <Timeline className="border-0">
              ...
              <Timeline.Item className="space-y-3 bg-gray-100 rounded-lg p-3 dark:bg-gray-800">
                <Timeline.Time>
                  <Badge className="w-fit">
                    <svg
                      aria-hidden="true"
...
export default EventScheduleTimelineThreeColumns;
