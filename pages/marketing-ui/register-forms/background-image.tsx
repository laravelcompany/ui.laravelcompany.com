...
const BackgroundImageRegisterForm: FC = function () {
  return (
        ...
        <div className="w-full rounded-lg bg-white shadow dark:bg-gray-800 sm:max-w-md md:mt-0 xl:p-0">
          <div className="space-y-4 p-6 sm:p-8 md:space-y-6 lg:space-y-8">
            ...
            <form className="space-y-4 md:space-y-6" action="#">
              ...
              <div className="grid grid-cols-1 gap-2">
                <Label htmlFor="username" className="dark:text-white">Password</Label>
                <TextInput
                  id="username"
                  name="username"
                  placeholder="••••••••"
...
export default BackgroundImageRegisterForm;
