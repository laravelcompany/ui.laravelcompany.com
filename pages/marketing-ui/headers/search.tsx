import { Navbar, TextInput, Label, Dropdown, Button } from "flowbite-react";
  ...
  return (
    <header>
      <Navbar>
        ...
        >
          <form className="mb-3 flex items-center gap-3 w-full md:hidden">
          ...
          <Navbar.Link active href="#" className="bg-transparent text-gray-700">
            Home
          </Navbar.Link>
