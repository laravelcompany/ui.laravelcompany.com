...
const PromotionalPopup: FC = function () {
  const [show, setShow] = useState(false);

  return (
    <>
      <Button onClick={() => setShow(true)}>Preview promotional popup</Button>
      <Modal show={show} size="2xl" theme={{content: {inner: "relative rounded-lg bg-white shadow dark:bg-gray-800 flex flex-col max-h-[90vh]"}}}>
        <Modal.Body>
          <img
            alt=""
          ...
          <div className="flex items-center space-x-4 pt-0">
            ...
            <Button color="gray" onClick={() => setShow(false)} outline className="dark:bg-gray-700 dark:enabled:hover:bg-gray-600 [&>span]:dark:bg-gray-700 [&>span]:dark:enabled:hover:bg-gray-600">
              I'm not interested
            </Button>
          </div>
        </Modal.Body>
