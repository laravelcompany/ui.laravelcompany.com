...
const FourColumnGridLayoutSocialMediaCTATeamSection: FC = function () {
  return (
    <section className="bg-white dark:bg-gray-900 antialiased">
      <div className="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
        ...
        <div className="grid grid-cols-1 mt-12 gap-y-12 gap-x-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
          <Card className="border-0 shadow-none [&>div]:p-0">
            <img
            ...
            <div className="mt-4 space-y-2">
              ...
              <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                Bonnie drives the technical strategy of the themesberg platform
                and brand.
              </p>
        ...
        <Alert color="gray" className="max-w-3xl mx-auto mt-8 lg:mt-16 w-full">
          <div className="w-full flex flex-col justify-between gap-3 md:gap-6 md:items-center md:flex-row">
            ...
            <a
              href="#"
              title=""
              className="inline-flex items-center text-base font-medium text-primary-600 hover:underline dark:text-primary-500 flex-shrink-0"
            >
              Join our team
              <svg
                aria-hidden="true"
...
export default FourColumnGridLayoutSocialMediaCTATeamSection;
