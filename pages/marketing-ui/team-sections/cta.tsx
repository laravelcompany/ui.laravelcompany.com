...
const CardsWithGridLayoutAndCTATeamSection: FC = function () {
  return (
    <section className="bg-white dark:bg-gray-900 antialiased">
      <div className="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
        ...
        <Alert color="gray" className="max-w-3xl mx-auto mt-8 lg:mt-16">
...
export default CardsWithGridLayoutAndCTATeamSection;
