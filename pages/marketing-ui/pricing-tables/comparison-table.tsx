  ...
  return (
    <section className="bg-white dark:bg-gray-900">
      <div className="mx-auto flex max-w-screen-xl flex-col items-center px-4 py-8 lg:px-6 lg:py-16">
        ...
        <Accordion collapseAll flush className="w-fit border-none w-full">
          <Accordion.Panel>
            <Accordion.Title
              theme={{
                base: "flex items-center justify-center w-auto mx-auto first:rounded-t-lg last:rounded-b-lg py-5 px-5 font-medium text-gray-500 dark:text-gray-400",
                open: {
                  on: "dark:text-primary-500 text-primary-600",
                  off: "text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-500",
                },
              }}
            >
              Show Detailed Plan Comparison
            </Accordion.Title>
            <Accordion.Content className="border-none px-0 max-w-full overflow-x-scroll">
