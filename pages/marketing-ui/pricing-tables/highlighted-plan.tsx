...
const HighlightedPlanPricingTable: FC = function () {
    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
        ...
        <div className="grid gap-8 xl:grid-cols-3 xl:gap-10">
          <div className="mx-auto flex max-w-xl flex-col rounded-lg border border-gray-200 bg-white p-6 text-center shadow dark:border-gray-700 dark:bg-gray-800 xl:max-w-lg xl:p-8">
            ...
            <p className="text-light mb-1 mt-4 text-gray-500 dark:text-gray-400">
            ...
            <Button href="#" className="my-6 dark:bg-gray-700 dark:hover:bg-gray-600" color="dark">
              Get started
            </Button>
          ...
          <div className="mx-auto flex max-w-xl flex-col rounded-lg border border-primary-600 bg-white p-6 text-center shadow dark:bg-gray-800 xl:max-w-lg xl:p-8">
            <div className="mb-2">
